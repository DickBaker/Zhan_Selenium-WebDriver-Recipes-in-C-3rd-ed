...
namespace SeleniumRecipesCSharp.ch02_locator;
[TestClass]
public class Ch02LocatorTest
{
    ...
    [TestMethod]
    public void TestGetURL() => driver.Url = "https://agileway.com.au/demo";

    [TestMethod]
    public void TestByID() => driver.FindElement(By.Id("submit_btn")).Click();

    [TestMethod]
    public void TestByName() => driver.FindElement(By.Name("comment")).SendKeys("Selenium Cool");

    [TestMethod]
    public void TestByLinkedText() => driver.FindElement(By.LinkText("Cancel")).Click();

    [TestMethod]
    public void TestByXPath() => driver.FindElement(By.XPath("//*[@id='div2']/input[@type='checkbox']")).Click();

    [TestMethod]
    public void TestByTag() => Assert.IsTrue(driver.FindElement(By.TagName("body")).Text.Contains("Selenium Locators"));
    ...
    [TestMethod]
    public void TestByCSSSelector() => driver.FindElement(By.CssSelector("#div2 > input[type='checkbox']")).Click();
    ...
    public void TestFindMultipleElements()
    {
        ...
        Console.WriteLine(checkbox_elems); // => 2
        checkbox_elems[1].Click();
    }

    [TestMethod]
    public void TestChainFindElement() => driver.FindElement(By.Id("div2")).FindElement(By.Name("same")).Click();
}