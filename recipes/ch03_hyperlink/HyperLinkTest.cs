...
namespace SeleniumRecipesCSharp.ch03_hyperlink;

[TestClass]
public class Ch03HyperLinkTest
{
    ...
    [TestMethod]
    public void TestClickLinkByText() => driver.FindElement(By.LinkText("Recommend Selenium")).Click();// Thread.Sleep(20000);

    [TestMethod]
    public void TestClickLinkByID() => driver.FindElement(By.Id("recommend_selenium_link")).Click();

    [TestMethod]
    public void TestClickLinkByPartialText() => driver.FindElement(By.PartialLinkText("Recommend Seleni")).Click();

    [TestMethod]
    public void TestClickLinkByXPath() => driver.FindElement(By.XPath("//p/a[text()='Recommend Selenium']")).Click();
    ...
    [TestMethod]
    public void TestClick3rdLinkUnderParagraphByCSS() => driver.FindElement(By.CssSelector("p  > a:nth-child(3)")).Click(); // the 3rd link
    ...
    [TestMethod]
    public void TestClickLinkOpeningNewWindowsOrTabRememberUrl()
    {
    ...
    [TestMethod]
    public void TestClickLinkOpeningNewWindowsOrTabChangeWindow()
    {
