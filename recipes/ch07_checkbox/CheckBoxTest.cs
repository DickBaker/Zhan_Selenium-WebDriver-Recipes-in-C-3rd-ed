...
namespace SeleniumRecipesCSharp.ch07_checkbox;

[TestClass]
public class Ch07CheckBoxTest
{
    ...
    [TestMethod]
    public void TestCheckByChainingLocators() => driver.FindElement(By.Id("div2")).FindElement(By.Name("same")).Click();
